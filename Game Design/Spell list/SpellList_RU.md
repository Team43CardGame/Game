...
- К + К + С — Выбранный игрок будет брать 1 карту каждый раз, когда он становится целью заклинания, эффект длится один круг
...
- С + К + К — Cлучайный игрок берет 2 карты и пропускает ход  
...
- С + С + Ж — Позволяет сделать второй ход подряд, также накладывает щит на 1 круг, до 1 заклинания
